"""Merge Phase 3 Best LoRA checkpoint (checkpoint-537) into standalone HuggingFace model
...
def main():
    parser = argparse.ArgumentParser(description="Merge and verify Phase 3 Best model")
    parser.add_argument("--base-model", default="outputs/ulm-1.7b-phase2-merged")
    parser.add_argument("--adapter-path", default="outputs/ulm-1.7b-phase3-chat-l40s/checkpoint-537")
    parser.add_argument("--output-dir", default="outputs/ulm-1.7b-phase3-best-merged")
    parser.add_argument("--report-path", default="reports/phase3_merge_verification.json")
